(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/1996/0189/t/39/assets/appstle-subscription.js?v=1683197913");
      ...
      RS.Config = {
        ...
        "moneyFormat": "{% raw %}<span class=mw-price>\u00A5{{amount_no_decimals}}<\/span>{% endraw %}",
        "oneTimePurchaseText": "One Time Purchase",
        "shop": "luy2001.myshopify.com",
